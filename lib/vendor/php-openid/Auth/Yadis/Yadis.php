...
class Auth_Yadis_Yadis {
     ...
     */
    static public function getHTTPFetcher($timeout = 20)
    {
    ...
    static public function curlPresent()
    {
     ...
     * @access private
     */
    static public function _getHeader($header_list, $names)
    {
     ...
     * @access private
     */
    static public function _getContentType($content_type_header)
    {
     ...
     * succeeded.
     */
    static public function discover($uri, &$fetcher,
