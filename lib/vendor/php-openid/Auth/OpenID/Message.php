...
class Auth_OpenID_Mapping {
     ...
     * if not.
     */
    static public function isA($thing)
    {
...
class Auth_OpenID_Message {
    ...
    static public function fromPostArgs($args)
    {
    ...
    static public function fromOpenIDArgs($openid_args)
    {
        // Takes an array.
    ...
    static public function fromKVForm($kvform_string)
    {
