...
class Auth_OpenID_SRegRequest extends Auth_OpenID_SRegBase {
     ...
     */
    static public function build($required=null, $optional=null,
                   $policy_url=null,
     ...
     */
    static public function fromOpenIDRequest($request, $cls='Auth_OpenID_SRegRequest')
    {
...
class Auth_OpenID_SRegResponse extends Auth_OpenID_SRegBase {
     ...
     */
    static public function fromSuccessResponse(&$success_response, $signed_only=true)
    {
        global $Auth_OpenID_sreg_data_fields;
