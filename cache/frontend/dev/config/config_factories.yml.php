...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/bo/projects/chitanka-rechnik/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/bo/projects/chitanka-rechnik/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/bo/projects/chitanka-rechnik/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/bo/projects/chitanka-rechnik/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/bo/projects/chitanka-rechnik/apps/frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'chitanka.mailer@googlemail.com',
      'password' => 'chitanka.mailer@google$vlastelin1991',
    ),
  ),
))));
